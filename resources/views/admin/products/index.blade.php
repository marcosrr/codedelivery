...
<div class="container">
	...
	<br /><a href="{{ route('admin.products.create') }}" class="btn btn-default">Novo produto</a><br />
	...
	{!! $products->render() !!} <!-- usas-e {! quando não se quer escapaar a informação que está sendo impressa-->
</div>
@endsection